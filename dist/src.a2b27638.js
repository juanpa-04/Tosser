...
},{}],"src/javascripts/dice.js":[function(require,module,exports) {
"use strict";
...
},{"./dom":"src/javascripts/dom.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _dice = require("./javascripts/dice");
...
function render(toggle) {
  ...
  if (toggle) {
    var newDice = (0, _dice.Dice)(5);
    (0, _dom.appendToParent)((0, _dom.getMainContainer)(), newDice.DOM);
  } else {
    var _newDice = (0, _dice.Dice)(6);

    (0, _dom.appendToParent)((0, _dom.getMainContainer)(), _newDice.DOM);
  }
}
},{"./javascripts/dice":"src/javascripts/dice.js","./javascripts/dom":"src/javascripts/dom.js","./styles/style.css":"src/styles/style.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
